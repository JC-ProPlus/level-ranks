...
function (_Component) {
  ...
  _proto.view = function view() {
    ...
    var pointsText = flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.forum.attribute('reflar-level-ranks.pointsText') || flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('reflar-level-ranks.lib.defaults.level');
    ...
    if (flarum_helpers_username__WEBPACK_IMPORTED_MODULE_3___default.a !== flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('core.lib.username.deleted_text')) {
      return m("div", {
        class: "PostUser-level",
        title: expTotal + " " + flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('reflar-level-ranks.forum.desc.expText')
      }, m("span", {
        class: "PostUser-text"
      }, m("span", {
